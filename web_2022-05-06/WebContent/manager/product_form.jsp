                  ...
                  <div class="col-lg">
                    <form action="/shoppingmall/product/add" method="POST" enctype="multipart/form-data">
						...
						<div class="input-group" id="product_price_wrapper">
                            ...
                            <input type="number" class="form-control" aria-label="Sizing example input" name="price" aria-describedby="inputGroup-sizing-sm">
                        </div>
                        
                        <div class="input-group" id="product_price_wrapper">
                            <span class="input-group-text">재고</span>
                            <input type="number" class="form-control" aria-label="Sizing example input" name="stock" aria-describedby="inputGroup-sizing-sm">
                        </div>
